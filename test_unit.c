/*    Linux/macOS:
      gcc -Wall -std=c11 -Isrc/include src/core/*.c src/commands/*.c test_unit.c -o bin/t
      ./bin/t
 
    Windows (CMD):
      gcc -Wall -std=c11 -Isrc/include src/core/*.c src/commands/*.c test_unit.c -o bin/t.exe
      bin\t.exe
*/
#include "minigit.h"
#include <stdio.h>
